...
Immutable Docker image: `ghcr.io/vivien83/captain-agent-os:v0.1.0-alpha.1`;
...
| [0.1.0-alpha.1 Release Notes](docs/releases/v0.1.0-alpha.1.md) | Early-access scope and known limitations |
