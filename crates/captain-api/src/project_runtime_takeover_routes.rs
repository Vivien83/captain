...
pub async fn takeover_project_runtime(
    ...
    crate::project_runtime_route_support::mutate_project_runtime(
        ...
        |runtime, _project| {
            ...
            append_runtime_event(
                ...
                "project.takeover",
                "Manual takeover",
                "The user took control. Captain should wait for explicit instructions in the project chat.",
                "user",
                &phase,
                "paused",
                serde_json::json!({}),
            );
            deactivate_runtime_orchestrator(runtime, "takeover");
        },
    )
    .await
}
...
#[cfg(test)]
#[path = "project_runtime_takeover_routes_tests.rs"]
mod project_runtime_takeover_routes_tests;
