...
pub struct Supervisor {
    ...
    /// Recoverable agent/runtime failures returned through normal Result paths.
    failure_count: AtomicU64,
    /// Total panics caught across supervised runtime tasks.
...
impl Supervisor {
    ...
    /// Record a recoverable failure returned through a normal Result path.
    ...
    /// Get the total number of recoverable failures since daemon start.
...
mod tests {
    ...
    #[test]
    fn test_failure_tracking_is_independent_from_panics() {
        let supervisor = Supervisor::new();
