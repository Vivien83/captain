...
pub fn default_client_ids() -> HashMap<&'static str, &'static str> {
    ...
    m.insert("google", "captain-google-client-id");
    m.insert("github", "captain-github-client-id");
    m.insert("microsoft", "captain-microsoft-client-id");
    m.insert("slack", "captain-slack-client-id");
    m
}

/// Resolve OAuth client IDs with config overrides applied on top of defaults.
pub fn resolve_client_ids(config: &captain_types::config::OAuthConfig) -> HashMap<String, String> {
...
mod tests {
    ...
    fn resolve_client_ids_uses_defaults() {
        let config = captain_types::config::OAuthConfig::default();
        let ids = resolve_client_ids(&config);
        assert_eq!(ids["google"], "captain-google-client-id");
        assert_eq!(ids["github"], "captain-github-client-id");
    }

    #[test]
    fn resolve_client_ids_applies_overrides() {
        let config = captain_types::config::OAuthConfig {
        ...
        assert_eq!(ids["github"], "captain-github-client-id"); // default
        assert_eq!(ids["microsoft"], "my-msft-id");
        assert_eq!(ids["slack"], "captain-slack-client-id"); // default
    }
}
