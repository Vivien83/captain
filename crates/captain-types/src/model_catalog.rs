...
// Referenced by captain-runtime drivers, model catalog, and embedding modules.
// ---------------------------------------------------------------------------

pub const ANTHROPIC_BASE_URL: &str = "https://api.anthropic.com";
pub const OPENAI_BASE_URL: &str = "https://api.openai.com/v1";
/// Phase-k.1: ChatGPT subscription endpoint used when authenticating Codex via
/// the OpenAI Codex CLI (browser OAuth on chat.openai.com), as opposed to a
/// classic OPENAI_API_KEY. The session token from `~/.codex/auth.json` only
/// works on this hostname, NOT on api.openai.com.
