...
pub struct RocketChatAdapter {
    ...
    /// Rocket.Chat user IDs allowed to address the bot (empty = deny all,
...
impl RocketChatAdapter {
    ...
    /// * `allowed_users` - Rocket.Chat user `_id` values authorised to address the bot
                ...
                for channel_id in &channels_to_poll {
                    ...
                    for msg in messages {
                        ...
                        if !crate::rbac::is_authorized(&allowed_users, &sender_id) {
                            debug!(
                                "Rocket.Chat: ignoring message from unauthorised user {sender_id} (allowed_users gate)"
                            );
                            continue;
                        }
...
mod tests {
    ...
    #[test]
    fn test_rocketchat_rbac_empty_denies() {
        let adapter = RocketChatAdapter::new(
            "https://chat.example.com".to_string(),
            "tok".to_string(),
            "uid".to_string(),
    ...
    #[test]
    fn test_rocketchat_rbac_explicit_list() {
        let adapter = RocketChatAdapter::new(
            "https://chat.example.com".to_string(),
            "tok".to_string(),
            "uid".to_string(),
