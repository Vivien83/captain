...
pub(crate) fn standalone_help(lang: crate::i18n::Lang) -> &'static str {
    match lang {
        crate::i18n::Lang::Fr => concat!(
            ...
            "/reasoning [auto|niveau] — voir ou choisir l'effort de réflexion\n",
            "/think        — afficher/masquer les blocs de raisonnement reçus\n",
            "/status       — info connexion & agent\n",
            "/agents       — lister les agents actifs\n",
            "/sessions     — lister toutes les sessions persistées\n",
            "/artifacts    — parcourir les fichiers produits vérifiés\n",
            "/runs         — résumer les exécutions d'outils conservées\n",
        ...
        crate::i18n::Lang::En => concat!(
            ...
            "/reasoning [auto|level] — inspect or select reasoning effort\n",
            "/think        — show/hide received reasoning blocks\n",
            "/status       — connection & agent info\n",
            "/agents       — list running agents\n",
            "/sessions     — list every persisted session\n",
            "/artifacts    — browse checksum-verified produced files\n",
            "/runs         — summarize retained tool runs\n",
