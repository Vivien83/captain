...
const FRENCH_TRANSLATIONS: &[(&str, &str)] = &[
    ...
    (
        ...
        concat!(
            ...
            "/artifacts    \u{2014} parcourir les fichiers produits vérifiés\n",
            "/runs         \u{2014} inspecter et piloter les exécutions d'outils\n",
            ...
            "Routes opérateur exactes: /agents, /sessions, /artifacts, /runs, /logs, /settings, /health, /version\n",
...
const ENGLISH_TRANSLATIONS: &[(&str, &str)] = &[
    ...
    (
        ...
        concat!(
            ...
            "/artifacts    \u{2014} browse checksum-verified produced files\n",
            "/runs         \u{2014} inspect and control retained tool runs\n",
            ...
            "Exact operator routes: /agents, /sessions, /artifacts, /runs, /logs, /settings, /health, /version\n",
