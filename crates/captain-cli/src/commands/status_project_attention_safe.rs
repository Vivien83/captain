...
pub(super) fn safe_runtime_status(status: &str) -> &'static str {
    match status {
        "paused" => "paused",
        "blocked" => "blocked",
        "failed" => "failed",
...
pub(super) fn safe_runtime_phase(phase: &str) -> &'static str {
    match phase {
        "observe" => "observe",
        "think" => "think",
        "plan" => "plan",
...
pub(super) fn safe_resume_pending_reason(reason: Option<&str>) -> Option<&'static str> {
    match reason {
...
pub(super) fn safe_worker_status(status: Option<&Value>) -> &'static str {
...
pub(super) fn safe_pending_question(question: Option<&Value>) -> Value {
...
pub(super) fn safe_tool_request(phase: &str, request: &Value) -> Value {
    json!({
        "phase": Value::String(safe_runtime_phase(phase).to_string()),
...
pub(super) fn safe_last_event(event: Option<&Value>) -> Value {
