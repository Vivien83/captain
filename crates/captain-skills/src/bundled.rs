...
//!
//! Ships 60 prompt-only skills inside the Captain binary via `include_str!()`.
...
pub fn bundled_skills() -> Vec<(&'static str, &'static str)> {
    vec![
        ...
        (
            ...
            include_str!("../bundled/development-planning/SKILL.md"),
        ),
        (
            "test-driven-development",
            include_str!("../bundled/test-driven-development/SKILL.md"),
        ),
        (
            "systematic-debugging",
            include_str!("../bundled/systematic-debugging/SKILL.md"),
        ),
        (
            "subagent-driven-development",
            include_str!("../bundled/subagent-driven-development/SKILL.md"),
        ),
        (
            "requesting-code-review",
            include_str!("../bundled/requesting-code-review/SKILL.md"),
        ),
        // Tier 1 (8)
...
mod tests {
    ...
    fn test_bundled_skills_count() {
        ...
        assert_eq!(skills.len(), 65, "Expected 65 bundled skills");
    }
