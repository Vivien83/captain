...
below pins `v0.1.0-alpha.1` explicitly.

### macOS / Linux Desktop

```bash
curl -fsSL https://github.com/Vivien83/captain/releases/download/v0.1.0-alpha.1/install.sh \
  | CAPTAIN_VERSION=v0.1.0-alpha.1 CAPTAIN_PROFILE=desktop bash
```
...
```bash
curl -fsSL https://github.com/Vivien83/captain/releases/download/v0.1.0-alpha.1/install.sh \
  | CAPTAIN_VERSION=v0.1.0-alpha.1 \
    CAPTAIN_PROFILE=vps \
...
```powershell
$env:CAPTAIN_VERSION = "v0.1.0-alpha.1"
irm https://github.com/Vivien83/captain/releases/download/v0.1.0-alpha.1/install.ps1 | iex
```
