...
`v0.1.0-alpha.1`; pin it explicitly because GitHub's `/releases/latest`
...
```bash
CAPTAIN_IMAGE_TAG=v0.1.0-alpha.1 docker compose pull
CAPTAIN_IMAGE_TAG=v0.1.0-alpha.1 docker compose up -d --no-build
```
