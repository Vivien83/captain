...
不可变 Docker 镜像：`ghcr.io/vivien83/captain-agent-os:v0.1.0-alpha.8`；
...
| [0.1.0-alpha.8 Release Notes](docs/releases/v0.1.0-alpha.8.md) | Captain Forge 原生能力与真实的实时订阅配额 |
