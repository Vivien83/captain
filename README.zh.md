...
不可变 Docker 镜像：`ghcr.io/vivien83/captain-agent-os:v0.1.0-alpha.3`；
...
| [0.1.0-alpha.3 Release Notes](docs/releases/v0.1.0-alpha.3.md) | 托管 MemPalace、持久化记忆恢复与 Alpha 限制 |
